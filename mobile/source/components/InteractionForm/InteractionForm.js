    ...
    render() {
        ...
        return(
            <FlatList
                ...
                data={data}
                renderItem={({item}) => renderFormItem(item, this.props.color, this.props.highlightColor)}
...
function renderFormItem(item, color, highlightColor) {
    const {question, type, response} = item;
